...
try:
    ...
    raise SystemExit,  "Unable to load module:" + message
...
PYGAME = r"C:\\Python27\\Lib\\site-packages\\pygame\\"
...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "terrainui.py"
 
        #Name of program
        self.project_name = "terrainui"
 
        #Project url
        self.project_url = ('URLTOGAME-%s.tar.gz' % game.common.version)
 
        #Version of program
        self.project_version = game.common.version
 
        #License of the program
        self.license = "GPL"
 
        #Auhor of program
        self.author_name = "Paul Paterson"
        self.author_email = "ppaterson%gmail.com"
        self.copyright = "Copyright (c) 2011 Paul Paterson."
 
        #Description
        self.project_description = "terrainui"
